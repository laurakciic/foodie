...
import com.example.foodie.util.Constants.Constants.BASE_IMAGE_URL
import com.example.foodie.util.RecipesDiffUtil
import foodie.R
import foodie.databinding.IngredientsRowLayoutBinding
import java.util.*
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    fun setData(newIngredients: List<ExtendedIngredient>) {
        ...
        diffUtilResult.dispatchUpdatesTo(this)      // this refers to RecyclerView Adapter
    }
}